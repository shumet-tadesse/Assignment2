...
public class LifeStatus implements Serializable {
	...
	@TableGenerator(name="sqlite_lifestatus", table="sqlite_sequence",
	    pkColumnName="name", valueColumnName="seq",	    pkColumnValue="LifeStatus")
	...
	private MeasureDefinition measureDefinition1;
	...
	public MeasureDefinition getMeasureDefinition1() {
		return measureDefinition1;
	}

	public void setMeasureDefinition1(MeasureDefinition param) {
		this.measureDefinition1 = param;
	}
